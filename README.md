...
This got me thinking and I scoured the internet for a relatable data set. Unfortunately, there aren't that many freely available data sets on fishing tournments and fish weights, so I settled for getting creative with the fish market data set. 
